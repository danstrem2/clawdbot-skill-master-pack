...
def update_readme():
    ...
    try:
        ...
        print("❌ README.md not found in root. Creating one...")
        content = "# Antigravity Skills\n\n## Full Skill Registry (0/0)\n"
    ...
    if not header_match:
        print("⚠️ 'Full Skill Registry' header not found. Appending to end of file.")
        content += f"\n\n## Full Skill Registry ({total_skills}/{total_skills})\n"
        # Re-search to find it now
        header_match = re.search(header_pattern, content)
